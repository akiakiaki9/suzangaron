...
export default function PrintPage() {
    ...
    const menuData = {
        ...
        eastern: {
            ...
            items: [
                { name: 'ПЛОВ СУЗАНГАРОН', weight: '1 порция', price: '65 000' }, // Цена изменена на 65 000
        ...
        european: {
            ...
            items: [
                { name: 'РАТАТУЙ', weight: '500 гр', price: '', desc: 'говядина, баклажан, помидор, винный соус' }, // Добавлен Рататуй
                { name: 'ВАРАХША', weight: '300 гр', price: '', desc: 'говядина, помидор, чеснок' }, // Добавлен Варахша
                { name: 'БАРАНИНА ЧЕХОЛБЕН', weight: '', price: '85 000', desc: 'баранина, лук, помидор, перец, зелень, чеснок' }, // Добавлена Баранина чехолбен
        ...
        salads: {
            ...
            items: [
                { name: 'САЛАТ СУЗАНГАРОН', weight: '350 гр', price: '85 000', desc: 'руколла 60гр, черри 30гр, огурец 20гр, шампиньоны 20гр, перец болгарский 20гр, красный лук 10гр, сыр пармезан 15гр, мясо 100гр, соус 50гр, мини кукуруза 15-20гр' }, // Добавлен салат
